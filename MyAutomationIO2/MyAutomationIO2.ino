...
#define DIGITAL_INPUT_PINCONFIG(pin) \
  { (pin), "digitalInput", {CHAR_UUID_DIGITAL, sizeof(uint8_t), BLE_CLIENT_ACCESS_READ_ONLY, BLE_CLIENT_NOTIFY_ENABLED}, {DESC_UUID_NUMDIGITALS, sizeof(uint8_t), BLE_CLIENT_ACCESS_READ_ONLY} }
#define DIGITAL_OUTPUT_PINCONFIG(pin) \
  { (pin), "digitalOutput", {CHAR_UUID_DIGITAL, sizeof(long), BLE_CLIENT_ACCESS_WRITE_ONLY, BLE_CLIENT_NOTIFY_WITH_ACK}, {DESC_UUID_NUMDIGITALS, sizeof(long), BLE_CLIENT_ACCESS_READ_ONLY} }
...
#define CHAR_UUID_FILE_DATA (0xFEED)
BleCharacteristic fileDataChar(CHAR_UUID_FILE_DATA, 1, BLE_CLIENT_ACCESS_WRITE_ONLY, BLE_CLIENT_NOTIFY_WITH_ACK);
...
//  fileDataChar.setEventCallback(fileDataCharEventCb);
  ...
  ioService.addCharacteristic(fileDataChar);
    fileDataChar.setEventCallback(fileDataCharEventCb);
//  CHECK_STATUS(ioService.addCharacteristic(fileDataChar));
